...
export const SessionRoutes = lazy(() =>
  new Hono()
    .get(
      ...
      validator(
        ...
        z.object({
          ...
          search: z.string().optional().meta({ description: "Filter sessions by title or message content (case-insensitive)" }),
    ...
    .post(
      ...
      validator("json", zodObject(SessionPrompt.PromptInput).omit({ sessionID: true, source: true, rootRequestID: true })),
      async (c) => {
        c.status(200)
