...
export const Event = {
  ...
  ReviewCompleted: EventV2.define({
  ...
  ReviewFailed: EventV2.define({
    type: "permission.review.failed",
    schema: { sessionID: PermissionV1.Request.fields.sessionID, reviewID: Schema.String, reason: Schema.String },
  }),
  CircuitBroken: EventV2.define({
    type: "permission.review.circuit_broken",
    schema: { sessionID: PermissionV1.Request.fields.sessionID, consecutive: Schema.Number, recent: Schema.Number },
  }),
}
...
export const AutoDeniedError = PermissionV1.AutoDeniedError
export type AutoDeniedError = PermissionV1.AutoDeniedError
        ...
        if (cache && (yield* cache.has(autoRequest))) {
          ...
          const decision = yield* PermissionAuto.evaluate(
            ...
            (review) =>
              ...
              events.publish(Event.ReviewStarted, {
