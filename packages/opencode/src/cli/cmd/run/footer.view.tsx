...
export function RunFooterView(props: RunFooterViewProps) {
  ...
  const modelStatus = createMemo(() => {
    ...
    return {
      ...
      provider: model().provider === "opencode" ? undefined : model().provider,
    }
  })
              ...
              >
                ...
                >
                  <Show when={busy() && !exiting()}>
                    <box flexShrink={0}>
                      <SpinnerIcon color={spin().color} frames={spin().frames} interval={40} width={8} />
                    </box>
                  </Show>
                ...
                <Show when={responsive().statusline.showModel && modelStatus()}>
                  {(info) => (
                    <box
                      ...
                      backgroundColor="transparent"
                      flexShrink={0}
                      maxWidth={responsive().statusline.contextHintLimit === undefined ? 72 : 36}
                    >
