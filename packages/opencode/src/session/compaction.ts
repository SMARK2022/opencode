...
function renderInspectedFiles(input: { events: ToolEvent[]; fs: FSUtil.Interface; worktree: string }) {
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const processCompaction = Effect.fn("SessionCompaction.process")(function* (input: {
      ...
      const nextPrompt = compacting.prompt ?? buildPrompt({ previousSummary, context: compacting.context, template: SUMMARY_TEMPLATE })
