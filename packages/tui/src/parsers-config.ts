export default {
  ...
  parsers: [
    ...
    {
      filetype: "bash",
      // TUI filetype mapping follows VS Code/LSP's `shellscript` language id.
      // Keep these aliases at the parser layer so code fences and shell files use
      // the bash highlighter without changing language IDs elsewhere.
