...
const shortString = FastCheck.string({ maxLength: 24 })
const configKey = FastCheck.string({ minLength: 1, maxLength: 12 })
const permissionAction = FastCheck.constantFrom("allow" as const, "ask" as const, "auto" as const, "deny" as const)
const jsonLeaf = FastCheck.oneof(shortString, FastCheck.boolean(), FastCheck.integer({ min: 0, max: 1_000 }))
const v1ProviderModel = FastCheck.record(
  {
    id: FastCheck.option(shortString, { nil: undefined }),
    name: FastCheck.option(shortString, { nil: undefined }),
    family: FastCheck.option(shortString, { nil: undefined }),
    options: FastCheck.option(FastCheck.dictionary(configKey, jsonLeaf, { maxKeys: 3 }), { nil: undefined }),
    variants: FastCheck.option(
      FastCheck.dictionary(configKey, FastCheck.dictionary(configKey, jsonLeaf, { maxKeys: 3 }), { maxKeys: 3 }),
      { nil: undefined },
    ),
  },
  { requiredKeys: [] },
)
const boundedV1Info = FastCheck.record(
  {
    $schema: FastCheck.option(shortString, { nil: undefined }),
    shell: FastCheck.option(shortString, { nil: undefined }),
    model: FastCheck.option(shortString, { nil: undefined }),
    small_model: FastCheck.option(shortString, { nil: undefined }),
    default_agent: FastCheck.option(shortString, { nil: undefined }),
    username: FastCheck.option(shortString, { nil: undefined }),
    snapshot: FastCheck.option(FastCheck.boolean(), { nil: undefined }),
    watcher: FastCheck.option(FastCheck.record({ ignore: FastCheck.array(shortString, { maxLength: 3 }) }), {
      nil: undefined,
    }),
    autoshare: FastCheck.option(FastCheck.boolean(), { nil: undefined }),
    share: FastCheck.option(FastCheck.constantFrom("manual" as const, "auto" as const, "disabled" as const), {
      nil: undefined,
    }),
    tools: FastCheck.option(FastCheck.dictionary(configKey, FastCheck.boolean(), { maxKeys: 4 }), { nil: undefined }),
    permission: FastCheck.option(
      FastCheck.dictionary(
        configKey,
        FastCheck.oneof(permissionAction, FastCheck.dictionary(configKey, permissionAction, { maxKeys: 3 })),
        { maxKeys: 4 },
      ),
      { nil: undefined },
    ),
    command: FastCheck.option(
      FastCheck.dictionary(
        configKey,
        FastCheck.record(
          {
            template: shortString,
            description: FastCheck.option(shortString, { nil: undefined }),
            agent: FastCheck.option(shortString, { nil: undefined }),
            model: FastCheck.option(shortString, { nil: undefined }),
            variant: FastCheck.option(shortString, { nil: undefined }),
            subtask: FastCheck.option(FastCheck.boolean(), { nil: undefined }),
          },
    ...
    provider: FastCheck.option(
      FastCheck.dictionary(
        configKey,
        FastCheck.record(
          {
            name: FastCheck.option(shortString, { nil: undefined }),
            env: FastCheck.option(FastCheck.array(shortString, { maxLength: 3 }), { nil: undefined }),
            npm: FastCheck.option(shortString, { nil: undefined }),
            api: FastCheck.option(shortString, { nil: undefined }),
            options: FastCheck.option(FastCheck.dictionary(configKey, jsonLeaf, { maxKeys: 3 }), { nil: undefined }),
            models: FastCheck.option(FastCheck.dictionary(configKey, v1ProviderModel, { maxKeys: 3 }), {
              nil: undefined,
            }),
          },
          { requiredKeys: [] },
    ...
    references: FastCheck.option(FastCheck.dictionary(configKey, shortString, { maxKeys: 3 }), { nil: undefined }),
    reference: FastCheck.option(FastCheck.dictionary(configKey, shortString, { maxKeys: 3 }), { nil: undefined }),
    instructions: FastCheck.option(FastCheck.array(shortString, { maxLength: 3 }), { nil: undefined }),
  },
  { requiredKeys: [] },
)
...
describe("Config", () => {
  ...
  it.effect("migrates arbitrary v1 configuration into valid v2 configuration", () =>
    Effect.sync(() => {
      FastCheck.assert(
        FastCheck.property(boundedV1Info, (info) => {
          Schema.decodeUnknownSync(Config.Info)(
            ConfigMigrateV1.migrate(Schema.decodeUnknownSync(ConfigV1.Info)(info)),
            { errors: "all" },
          )
        }),
        { numRuns: 100 },
