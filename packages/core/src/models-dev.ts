...
export const defaultLayer = layer.pipe(
  ...
  // models.dev is infrastructure metadata, not a provider SDK request. Keep the
  // HTTP seam proxy-aware so Windows/macOS system proxy resolution stays centralized.
