...
const SessionsQueryFields = {
  ...
  start: Schema.NumberFromString.pipe(Schema.optional).annotate({
    description: "Only include sessions created at or after this Unix epoch timestamp in milliseconds.",
  }),
}
