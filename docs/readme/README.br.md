...
<p align="center">
  ...
  <a href="https://github.com/SMARK2022/opencode/releases"><img alt="Versao SMARK atual" src="https://img.shields.io/badge/current-1.15.14-f97316?style=flat-square" /></a>
</p>
...
Esta e a forma completa: `bash -s --` diz ao `bash` para ler o instalador de stdin e passar `--version 1.15.14-smark` como argumentos do instalador. A versao pode ser `1.15.14-smark` ou a forma de release tag `v1.15.14-smark`.
...
| VS Code | Agents CLI nao reutilizam diretamente servicos de linguagem nem operam Notebooks de forma confiavel | Diagnosticos, navegacao e simbolos via VS Code, edicao e execucao de celulas, gerenciamento de kernel |
...
| `vscode_notebook_env` | Inspecionar kernel/runtime, selecionar, reiniciar ou parar o kernel e criar ou salvar um notebook quando solicitado pelo usuario |
