...
<p align="center">
  ...
  <a href="https://github.com/SMARK2022/opencode/releases"><img alt="Versao SMARK atual" src="https://img.shields.io/badge/current-1.15.13-f97316?style=flat-square" /></a>
</p>
...
Esta e a forma completa: `bash -s --` diz ao `bash` para ler o instalador de stdin e passar `--version 1.15.13-smark` como argumentos do instalador. A versao pode ser `1.15.13-smark` ou a forma de release tag `v1.15.13-smark`.
