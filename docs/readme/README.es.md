...
Esta es la forma completa: `bash -s --` indica a `bash` que lea el installer desde stdin y pase `--version 1.15.13-smark` como argumentos del installer. La versión puede ser `1.15.13-smark` o la forma de release tag `v1.15.13-smark`.
