# Patch Dry Run typecheck-0085-2026-07-20T00-37-21-032Z
...
```text
src/plugin/index.ts(74,5): error TS2322: Type '() => { tool: { vscode_notebook_summary: { description: string; args: { filePath: z.ZodString; }; execute(args: { filePath: string; }, context: ToolContext): Promise<ToolResult>; }; ... 4 more ...; vscode_notebook_env: { description: string; args: { filePath: z.ZodString; }; execute(args: { filePath: string; }, cont...' is not assignable to type 'Plugin'.
  Type '{ tool: { vscode_notebook_summary: { description: string; args: { filePath: z.ZodString; }; execute(args: { filePath: string; }, context: ToolContext): Promise<ToolResult>; }; ... 4 more ...; vscode_notebook_env: { description: string; args: { filePath: z.ZodString; }; execute(args: { filePath: string; }, context: T...' is missing the following properties from type 'Promise<Hooks>': then, catch, [Symbol.toStringTag], finally
