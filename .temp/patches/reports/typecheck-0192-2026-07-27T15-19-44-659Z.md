# Patch Dry Run typecheck-0192-2026-07-27T15-19-44-659Z
...
- Materialized index: 192
- State directory: `/Users/sunbenteng/Project/opencode/thirdparty/opencode-v1.17.18-smark/.temp/patches/states/0192-b47dd66b83c5`
- Retained states: 0192-b47dd66b83c5, 0191-a8478caff8aa
...
- Install: installed (bfd9217687f98d6db47035044c1b3c6a51a6d00496972d6f8f1b5fadee0a426f)
...
```text
test/cli/cmd/tui/prompt-submit-transport.test.tsx(185,5): error TS2345: Argument of type '(url: any, request: any, init: any) => Response | undefined' is not assignable to parameter of type 'FetchHandler'.
  Target signature provides too few arguments. Expected 3 or more, but got 1.
test/cli/cmd/tui/prompt-submit-transport.test.tsx(185,6): error TS7006: Parameter 'url' implicitly has an 'any' type.
test/cli/cmd/tui/prompt-submit-transport.test.tsx(185,11): error TS7006: Parameter 'request' implicitly has an 'any' type.
test/cli/cmd/tui/prompt-submit-transport.test.tsx(185,20): error TS7006: Parameter 'init' implicitly has an 'any' type.
