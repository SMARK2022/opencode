# Patch Dry Run typecheck-0060-2026-07-19T03-02-24-478Z
...
```text
src/cli/tui/worker.ts(45,47): error TS2345: Argument of type 'Promise<string>' is not assignable to parameter of type 'string'.
src/cli/tui/worker.ts(46,22): error TS7036: Dynamic import's specifier must be of type 'string', but here has type 'Promise<PluginEntry>'.
