# Patch Dry Run materialize-0025-2026-07-18T01-18-11-353Z
...
| 23 | `b2b12b0abfcd` | failed | check | conflict | feat: 添加 extends 字段以支持从现有提供者类型继承模型和默认值，更新相关逻辑，同时添加claude的header |
