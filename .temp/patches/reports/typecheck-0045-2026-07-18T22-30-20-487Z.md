# Patch Dry Run typecheck-0045-2026-07-18T22-30-20-487Z
...
```text
src/session/processor.ts(106,13): error TS2741: Property 'toolInputBuffer' is missing in type '{ assistantMessage: SessionV1.Assistant; sessionID: string & Brand<"SessionID">; model: { id: string & Brand<"ModelV2.ID">; providerID: string & Brand<"ProviderV2.ID">; ... 10 more ...; variants?: { ...; } | undefined; }; ... 6 more ...; reasoningMap: {}; }' but required in type 'ProcessorContext'.
