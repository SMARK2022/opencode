# Patch Dry Run materialize-0008-2026-07-17T17-49-01-571Z
...
| 8 | `4d3c3d4e546a` | failed | check | unknown | feat(build): 添加操作系统过滤功能以优化目标构建 |

## Failure Output

### #8 4d3c3d4e546a4a399c1b839c76c109c7bddb1ebb
