# Patch Dry Run typecheck-0085-2026-07-20T00-35-54-626Z
...
- Retained states: 0085-66ddc4e2fe6c, 0080-0a8361dfa4d3, 0077-9768471cf3fc
...
```text
src/plugin/index.ts(74,5): error TS2322: Type '() => { init: () => Effect.Effect<void, never, never>; tool: { vscode_notebook_summary: { description: string; args: { filePath: z.ZodString; }; execute(args: { filePath: string; }, context: ToolContext): Promise<...>; }; ... 4 more ...; vscode_notebook_env: { description: string; args: { filePath: z.ZodString; }; e...' is not assignable to type 'Plugin'.
  Type '{ init: () => Effect.Effect<void, never, never>; tool: { vscode_notebook_summary: { description: string; args: { filePath: z.ZodString; }; execute(args: { filePath: string; }, context: ToolContext): Promise<...>; }; ... 4 more ...; vscode_notebook_env: { description: string; args: { filePath: z.ZodString; }; execute...' is missing the following properties from type 'Promise<Hooks>': then, catch, [Symbol.toStringTag], finally
