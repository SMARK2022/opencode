# Patch Dry Run typecheck-0075-2026-07-19T17-50-38-961Z
...
```text
src/session/prompt.ts(1378,78): error TS2339: Property 'length' does not exist on type 'never'.
src/session/prompt.ts(1379,100): error TS2339: Property 'reduce' does not exist on type 'never'.
