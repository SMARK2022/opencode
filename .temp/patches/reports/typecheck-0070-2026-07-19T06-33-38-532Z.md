# Patch Dry Run typecheck-0070-2026-07-19T06-33-38-532Z
...
```text
../core/src/database/database.ts(78,20): error TS2352: Conversion of type 'SQLiteEffectRaw<EffectSQLiteRunResult, EffectSQLiteQueryEffectHKT>' to type 'Effect<unknown, never, never>' may be a mistake because neither type sufficiently overlaps with the other. If this was intentional, convert the expression to 'unknown' first.
  Types of property '[TypeId]' are incompatible.
    Type 'Variance<EffectSQLiteRunResult, EffectDrizzleQueryError, never>' is not comparable to type 'Variance<unknown, never, never>'.
      Type 'EffectDrizzleQueryError' is not comparable to type 'never'.
