# Patch Dry Run typecheck-0090-2026-07-20T05-47-13-395Z
...
```text
src/tool/shell.ts(17,60): error TS2459: Module '"./bash-compress"' declares 'compressVisibleOutput' locally, but it is not exported.
