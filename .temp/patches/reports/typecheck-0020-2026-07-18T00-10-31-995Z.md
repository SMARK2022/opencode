# Patch Dry Run typecheck-0020-2026-07-18T00-10-31-995Z
...
```text
src/session/prompt.ts(483,256): error TS2339: Property 'variant' does not exist on type '{ readonly providerID: string & Brand<"ProviderV2.ID">; readonly modelID: string & Brand<"ModelV2.ID">; }'.
