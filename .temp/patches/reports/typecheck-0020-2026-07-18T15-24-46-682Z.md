# Patch Dry Run typecheck-0020-2026-07-18T15-24-46-682Z
...
```text
src/cli/cmd/stats.ts(202,115): error TS2339: Property 'reasoningTokens' does not exist on type '{ providerId: string; modelId: string; inputTokens: number; outputTokens: number; cacheRead: number; cacheWrite: number; costMicros: number; }'.
